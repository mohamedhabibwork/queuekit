...
**Full Changelog**: https://github.com/mohamedhabibwork/queuekit/compare/v0.1.0...v0.2.0

### Commits

- b60ef71 fix(ci): set GH_REPO in changelog job so gh works without checkout
- 3bd852d 0.2.0
- e157aac feat: in-memory fake testing driver with deterministic controls
- d5f20fa build: pin esbuild via overrides
- 6305835 ci: publish on v* tag push with generated release notes
- 1d82ce6 docs: add README badges
- 69ef1f1 fix: update actions/checkout to v7 in CI workflows
- 22c2d2e ci: fix compatibility and Pages workflows
